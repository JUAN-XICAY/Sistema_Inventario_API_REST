...
export function TablaCategoria({ categorias, handleDelete }) {
      ...
      cell: (info) => (
        <td className="ContentCell">
          <ContentAccionesTabla
            funcionEditar={() =>
              navigate(`/configuracion/categoria/${info.row.original.id}/edit`)
            }
  ...
  const table = useReactTable({
    data: categorias, // Cambiado de 'marcas' a 'data'
    columns,
