...
export function TablaMarca({ marca, handleDelete }) {
  ...
  const columns = [
    ...
    },
    {
      ...
      header: "Logo ",
      cell: (info) => (
        <td data-title="Logo" className="ContentCell">
          {info.getValue() != "-" ? (
      ...
      cell: (info) => (
        <td className="ContentCell">
          <ContentAccionesTabla
            funcionEditar={() =>
              navigate(`/configuracion/marca/${info.row.original.id}/edit`)
            }
  ...
  const table = useReactTable({
    data: marca, // Cambiado de 'marcas' a 'data'
    columns,
